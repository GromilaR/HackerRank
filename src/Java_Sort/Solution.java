...
public class Solution {
    public static void main(String[] args) {
        ...
        Collections.sort(studentList, Solution::compare);
    ...
    // Optimazed solution ))
        return (o1.getCgpa() < o2.getCgpa())?1:(o1.getCgpa() == o2.getCgpa())?
                (o1.getFname().compareTo(o2.getFname()) != 0)?o1.getFname().compareTo(o2.getFname()):
                        (o1.getId() > o2.getId())?1:(o1.getId() == o2.getId())?0:-1:-1;

        // First Solution
  /*      if (o1.getCgpa() < o2.getCgpa()) return 1;
        else if (o1.getCgpa() == o2.getCgpa()) {
            if (o1.getFname().compareTo(o2.getFname()) != 0) return o1.getFname().compareTo(o2.getFname());
            else {
